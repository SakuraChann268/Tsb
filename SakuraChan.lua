loadstring(game:HttpGet(("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua")))()
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=135286045511610",
       Size = {60, 60},
...
------ Tab
     local Tab1o = MakeTab({Name = "Script Menu"})
     local Tab2o = MakeTab({Name = "Tech"})
------- BUTTON
...
AddButton(Tab2o, {
    ...
    Callback = function()
	  ...
	  loadstring(game:HttpGet("https://api.getpolsec.com/scripts/hosted/13d3955bf672272305cc6ec9ec42f5773b16541aa76237f626d2263adc64a374.lua"))()
	  end
     })